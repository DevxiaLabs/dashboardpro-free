...
This command **requires** the project directory as an argument via `/Users/juan/Proyectos/autoforge/dashboard`.

**Example:** `/create-spec generations/my-app`

**Output location:** `/Users/juan/Proyectos/autoforge/dashboard/.autoforge/prompts/app_spec.txt` and `/Users/juan/Proyectos/autoforge/dashboard/.autoforge/prompts/initializer_prompt.md`

If `/Users/juan/Proyectos/autoforge/dashboard` is empty, inform the user they must provide a project path and exit.
...
The output directory is: `/Users/juan/Proyectos/autoforge/dashboard/.autoforge/prompts/`

Once the user approves, generate these files:

## 1. Generate `app_spec.txt`

**Output path:** `/Users/juan/Proyectos/autoforge/dashboard/.autoforge/prompts/app_spec.txt`
...
**Output path:** `/Users/juan/Proyectos/autoforge/dashboard/.autoforge/prompts/initializer_prompt.md`
...
**Output path:** `/Users/juan/Proyectos/autoforge/dashboard/.autoforge/prompts/.spec_status.json`
...
> "Your specification files have been created in `/Users/juan/Proyectos/autoforge/dashboard/.autoforge/prompts/`!
>
> **Files created:**
> - `/Users/juan/Proyectos/autoforge/dashboard/.autoforge/prompts/app_spec.txt`
> - `/Users/juan/Proyectos/autoforge/dashboard/.autoforge/prompts/initializer_prompt.md`
>
